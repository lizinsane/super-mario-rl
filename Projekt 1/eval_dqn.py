...
if __name__ == "__main__":
    # Standard: mario_q_target.pth im gleichen Verzeichnis wie eval_dqn.py
    script_dir = os.path.dirname(os.path.abspath(__file__))
    default_ckpt = os.path.join(script_dir, "mario_q_target.pth")
    ckpt_path = sys.argv[1] if len(sys.argv) > 1 else default_ckpt
    
    print(f"Load DQN checkpoint from {ckpt_path}")
    n_frame = 4
